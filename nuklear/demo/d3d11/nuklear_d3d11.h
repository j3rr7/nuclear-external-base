...
nk_d3d11_init(ID3D11Device *device, int width, int height, unsigned int max_vertex_buffer, unsigned int max_index_buffer)
{
    ...
    d3d11.device = device;
    device->AddRef(); // ID3D11Device_AddRef(device);
...
nk_d3d11_font_stash_end(void)
{
    ...
    assert(SUCCEEDED(hr)); }
    font_texture->Release(); } // ID3D11Texture2D_Release(font_texture);}
...
void nk_d3d11_shutdown(void)
{
    ...
    d3d11.sampler_state->Release(); // ID3D11SamplerState_Release(d3d11.sampler_state);
    d3d11.font_texture_view->Release(); // ID3D11ShaderResourceView_Release(d3d11.font_texture_view);
    d3d11.vertex_buffer->Release(); // ID3D11Buffer_Release(d3d11.vertex_buffer);
    d3d11.index_buffer->Release(); // ID3D11Buffer_Release(d3d11.index_buffer);
    d3d11.blend_state->Release(); // ID3D11BlendState_Release(d3d11.blend_state);
    d3d11.pixel_shader->Release(); // ID3D11PixelShader_Release(d3d11.pixel_shader);
    d3d11.const_buffer->Release(); // ID3D11Buffer_Release(d3d11.const_buffer);
    d3d11.vertex_shader->Release(); // ID3D11VertexShader_Release(d3d11.vertex_shader);
    d3d11.input_layout->Release(); // ID3D11InputLayout_Release(d3d11.input_layout);
    d3d11.rasterizer_state->Release(); // ID3D11RasterizerState_Release(d3d11.rasterizer_state);
    d3d11.device->Release(); //ID3D11Device_Release(d3d11.device);
}
